...
//                btn_0.doClick();
    ...
    public static void loadData_official_schedule_types(List<Courses.to_courses> acc) {
    ...
    public static class Tblofficial_schedule_typesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Course", "", "", "created_by", "updated_by", "status", "schedule_type"
        };
    ...
    private void ret_official_schedule_types() {
        String where = "";
        List<Courses.to_courses> datas = Courses.ret_data(where);
    ...
    private void save_official_schedule_types() {
        ...
        if (row < 0) {
            ...
            Courses.to_courses to = new Courses.to_courses(id, created_at, updated_at, created_by, updated_by, status, upload_status, school_level_id, course);
            Courses.add_data(to);
            ret_official_schedule_types();
            Alert.set(1, course);
            clear_official_schedule_types();
        } else {
            Courses.to_courses to = (Courses.to_courses) tbl_official_schedule_types_ALM.get(row);
            int id = to.id;
            ...
            int upload_status = 0;
            String school_level_id = to.school_level_id;
            String course = jTextField1.getText();
            Courses.to_courses to1 = new Courses.to_courses(id, created_at, updated_at, created_by, updated_by, status, upload_status, school_level_id, course);
            Courses.update_data(to1);
            ret_official_schedule_types();
            Alert.set(2, course);
            clear_official_schedule_types();
        }
    ...
    private void select_official_schedule_types() {
        ...
        final Courses.to_courses to = (Courses.to_courses) tbl_official_schedule_types_ALM.get(row);
        if (col == 1) {
            jTextField1.setText(to.course);
        }
        if (col == 2) {
