 ...
 * @author Guinness
 */
public class Dlg_course_major extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_course_major(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_course_major(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_course_major myRef;

    private void setThisRef(Dlg_course_major myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_course_major> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_course_major create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_course_major create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_course_major dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_course_major((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_course_major((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_course_major dialog = Dlg_course_major.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void loadData_official_schedule_types(List<Course_majors.to_course_majors> acc) {
    ...
    public static class Tblofficial_schedule_typesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Major", "", "", "created_by", "updated_by", "status", "schedule_type"
        };
        ...
        public Object getValueAt(int row, int col) {
            Course_majors.to_course_majors tt = (Course_majors.to_course_majors) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.major;
                case 1:
    ...
    private void ret_official_schedule_types() {
        String where = "";
        List<Course_majors.to_course_majors> datas = Course_majors.ret_data(where);
    ...
    private void save_official_schedule_types() {
        ...
        if (row < 0) {
            ...
            int status = 0;
            int upload_status = 0;
            String school_level_id = "";
            String course_id = "";
            String major = jTextField1.getText();
            Course_majors.to_course_majors to = new Course_majors.to_course_majors(id, created_at, updated_at, created_by, updated_by, status, upload_status, school_level_id, course_id, major);
            Course_majors.add_data(to);
            ret_official_schedule_types();
            Alert.set(1, "");
            clear_official_schedule_types();
        } else {
            Course_majors.to_course_majors to2 = (Course_majors.to_course_majors) tbl_official_schedule_types_ALM.get(row);
            int id = to2.id;
    ...
    private void select_official_schedule_types() {
        ...
        final Course_majors.to_course_majors to = (Course_majors.to_course_majors) tbl_official_schedule_types_ALM.get(row);
        if (col == 1) {
            jTextField1.setText(to.major);
        }
        if (col == 2) {
